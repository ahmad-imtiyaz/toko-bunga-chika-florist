...
.cf-footer-social-btn:hover {
  background: rgba(192,72,90,.2);
  border-color: rgba(192,72,90,.4);
  ...
  <div class="cf-footer-main">
    ...
    <div class="cf-footer-brand">
      ...
      <div class="cf-footer-socials">
        <?php if ($instagram): ?>
        <a href="<?= $instagram ?>" target="_blank" rel="noopener" class="cf-footer-social-btn" title="Instagram">
        ...
        <?php endif; ?>
        <?php if ($facebook): ?>
        <a href="<?= $facebook ?>" target="_blank" rel="noopener" class="cf-footer-social-btn" title="Facebook">
...
<!-- Selalu tampil label "Pesan Sekarang" di desktop & mobile -->
